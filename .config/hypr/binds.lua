...
hl.bind(mainMod .. " + mouse:272", hl.dsp.window.float({ action = "toggle" }), { click = true, mouse = true})
hl.bind(mainMod .. " + mouse:273", hl.dsp.window.pin({ action = "toggle" }), { click = true, mouse = true})
